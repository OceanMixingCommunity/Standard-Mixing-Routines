function specvol_t_exact = gsw_specvol_t_exact(SA,t,p)

% gsw_specvol_t_exact                                       specific volume
%==========================================================================
%
% USAGE:  
%  specvol_t_exact = gsw_specvol_t_exact(SA,t,p)
%
% DESCRIPTION:
...
if ~(nargin == 3)
   error('gsw_specvol_t_exact:  Requires three inputs')
end %if
...
if (mt ~= ms | nt ~= ns)
    error('gsw_specvol_t_exact: SA and CT must have same dimensions')
end
...
elseif (ms == mp) & (ns == np)
    ...
    error('gsw_specvol_t_exact: Inputs array dimensions arguments do not agree')
end %if
