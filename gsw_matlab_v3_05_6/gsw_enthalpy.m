...
% CT_frozen = -1.79e-2 - 6.7157e-2.*SA - 9.2708e-4.*p;
% 
...
dynamic_enthalpy =  z.*(h001 + xs.*(h101 + xs.*(h201 + xs.*(h301 + xs.*(h401 ...
...
enthalpy = cp0.*CT + dynamic_enthalpy.*1e8;         %Note. 1e8 = db2Pa*1e4;
...
% to compute enthalpy from SA, CT, and p with the full TEOS-10 Gibbs
