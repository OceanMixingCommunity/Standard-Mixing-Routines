function chem_potential_water_ice = gsw_chem_potential_water_ice(t,p)

% gsw_chem_potential_water_ice           chemical potential of water in ice 
%==========================================================================
% 
% USAGE:  
%  chem_potential_water_ice = gsw_chem_potential_water_ice(t,p)
%
% DESCRIPTION:
...
if ~(nargin == 2)
   error('gsw_chem_potential_water_ice:  Requires two inputs')
end
...
elseif (mt == mp) & (nt == np)
    ...
    error('gsw_chem_potential_water_ice: Inputs array dimensions arguments do not agree')
end
...
chem_potential_water_ice = gsw_gibbs_ice(0,0,t,p);

if transposed
    chem_potential_water_ice = chem_potential_water_ice.';
end
