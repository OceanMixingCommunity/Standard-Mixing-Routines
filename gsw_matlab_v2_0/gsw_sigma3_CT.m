...
% gsw_sigma3_CT                              potential density anomaly with
%                                      reference sea pressure of 3000 dbar.
%==========================================================================
% 
% USAGE:  
%  sigma3_CT = gsw_sigma3_CT(SA,CT)
%
% DESCRIPTION:
...
t3000 = gsw_pt_from_t(SA,pt0,pr0,pr3000);

n0 = 0;
n1 = 1;

sigma3_CT = ones(size(SA))./gsw_gibbs(n0,n0,n1,SA,t3000,pr3000) ...
               - 1000;
