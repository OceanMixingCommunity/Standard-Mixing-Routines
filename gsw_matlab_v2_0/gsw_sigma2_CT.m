...
% gsw_sigma2_CT                              potential density anomaly with
%                                      reference sea pressure of 2000 dbar.
%==========================================================================
% 
% USAGE:  
%  sigma2_CT = gsw_sigma2_CT(SA,CT)
%
% DESCRIPTION:
...
t2000 = gsw_pt_from_t(SA,pt0,pr0,pr2000);

n0 = 0;
n1 = 1;

sigma2_CT = ones(size(SA))./gsw_gibbs(n0,n0,n1,SA,t2000,pr2000) ...
               - 1000;
