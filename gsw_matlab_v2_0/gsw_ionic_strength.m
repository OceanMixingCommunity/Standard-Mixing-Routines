function ionic_strength = gsw_ionic_strength(SA)

% gsw_ionic_strength                             ionic strength of seawater
%==========================================================================
%
% USAGE:
%  ionic_strength = gsw_ionic_strength(SA)
%
% DESCRIPTION:
...
if ~(nargin == 1)
   error('gsw_ionic_strength:  Requires one input')
end %if
