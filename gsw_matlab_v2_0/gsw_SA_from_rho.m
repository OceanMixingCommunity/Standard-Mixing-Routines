function SA = gsw_SA_from_rho(rho,t,p)

% gsw_SA_from_rho               Absolute Salinity from density measurements
% =========================================================================
%
% USAGE:
%   SA = gsw_SA_from_rho(rho,t,p)
%
% DESCRIPTION:
...
if (mt ~= md | nt ~= nd)
    error('gsw_SA_from_rho: rho and t must have same dimensions')
end
...
% the error in SA is typically no larger than 2x10^-13 g/kg. 
